function buildallmexfiles_in_demodfltctor
  % Builds all the MEX files in DemoMatlabJavaDefaultCtor's source tree
  %
  ...
  coderoot = fullfile(demodfltctor.globals.distroot, 'Mcode')
  mexSourceFiles = [
