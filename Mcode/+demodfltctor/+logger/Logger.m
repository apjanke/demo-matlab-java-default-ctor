classdef Logger
  ...
  % demodfltctor.logger logging happens.
  %
  ...
  % arguments.
  %    demodfltctor.logger.info(format, varargin)
  ...
  % message.
  %    demodfltctor.logger.warn(exception, format, varargin)
  %
  % See also:
  % demodfltctor.logger.error
  % demodfltctor.logger.warn
  % demodfltctor.logger.info
  % demodfltctor.logger.debug
  % demodfltctor.logger.trace
  %
  % Examples:
  %
  % log = demodfltctor.logger.Logger.getLogger('foo.bar.FooBar');
  ...
  methods (Static)
    function out = getLogger(identifier)
      ...
      out = demodfltctor.logger.Logger(jLogger);
    end
  end
