...
PROJECT=DemoMatlabJavaDefaultCtor
...
PROJECT_SUMMARY="Repro for Matlab's behavior with Java classes that have default constructors"

# Multi-sentence project description. No <, >, /, or & characters allowed!
PROJECT_DESCRIPTION="Repro for Matlab's behavior with Java classes that have default constructors"

# Home page web site for the project's author
AUTHOR_HOMEPAGE="https://github.com/apjanke/demo-matlab-java-default-ctor"
